...
var instrTable = []instrInfo{
	...
	// Illegal opcodes. They are not emulated, only used for disassembly.
	...
	{"???", 0xC7, AddrModeZp, 2, 5},
	{"???", 0xD7, AddrModeZpX, 2, 6},
	{"???", 0xCF, AddrModeAbs, 3, 6},
	{"???", 0xDF, AddrModeAbsX, 3, 7},
	{"???", 0xDB, AddrModeAbsY, 3, 7},
	{"???", 0xC3, AddrModeImm, 2, 8},
	{"???", 0xD3, AddrModeImm, 2, 8},
	{"???", 0xE7, AddrModeZp, 2, 5},
	{"???", 0xF7, AddrModeZpX, 2, 6},
	{"???", 0xEF, AddrModeAbs, 3, 6},
	{"???", 0xFF, AddrModeAbsX, 3, 7},
	{"???", 0xFB, AddrModeAbsY, 3, 7},
	{"???", 0xE3, AddrModeIndX, 2, 8},
	{"???", 0xF3, AddrModeIndY, 2, 8},
	{"???", 0xBB, AddrModeImm, 2, 2},
	{"???", 0xA7, AddrModeZp, 2, 3},
	{"???", 0xB7, AddrModeZpY, 2, 4},
	{"???", 0xAF, AddrModeAbs, 3, 4},
	{"???", 0xBF, AddrModeAbsY, 3, 4}, // +1 if page crossed
	{"???", 0xA3, AddrModeIndX, 2, 6},
	{"???", 0xB3, AddrModeIndY, 2, 5}, // +1 if page crossed
	{"???", 0xAB, AddrModeImm, 2, 2},
	{"???", 0x27, AddrModeZp, 2, 5},
	{"???", 0x37, AddrModeZpX, 2, 6},
	{"???", 0x2F, AddrModeAbs, 3, 6},
	{"???", 0x3F, AddrModeAbsX, 3, 7},
	{"???", 0x3B, AddrModeAbsY, 3, 7},
	{"???", 0x23, AddrModeIndX, 2, 8},
	{"???", 0x33, AddrModeIndY, 2, 8},
	{"???", 0x67, AddrModeZp, 2, 5},
	{"???", 0x77, AddrModeZpX, 2, 6},
	{"???", 0x6F, AddrModeAbs, 3, 6},
	{"???", 0x7F, AddrModeAbsX, 3, 7},
	{"???", 0x7B, AddrModeAbsY, 3, 7},
	{"???", 0x63, AddrModeIndX, 2, 8},
	{"???", 0x73, AddrModeIndY, 2, 8},
	{"???", 0x87, AddrModeZp, 2, 3},
	{"???", 0x97, AddrModeZpY, 2, 4},
	{"???", 0x8F, AddrModeAbs, 3, 4},
	{"???", 0x83, AddrModeIndX, 2, 6},
	...
	{"???", 0x07, AddrModeZp, 2, 5},
	{"???", 0x17, AddrModeZpX, 2, 6},
	{"???", 0x0F, AddrModeAbs, 3, 6},
	{"???", 0x1F, AddrModeAbsX, 3, 7},
	{"???", 0x1B, AddrModeAbsY, 3, 7},
	{"???", 0x03, AddrModeIndX, 2, 8},
	{"???", 0x13, AddrModeIndY, 2, 8},
	{"???", 0x47, AddrModeZp, 2, 5},
	{"???", 0x57, AddrModeZpX, 2, 6},
	{"???", 0x4F, AddrModeAbs, 3, 6},
	{"???", 0x5F, AddrModeAbsX, 3, 7},
	{"???", 0x5B, AddrModeAbsY, 3, 7},
	{"???", 0x43, AddrModeIndX, 2, 8},
	{"???", 0x53, AddrModeIndY, 2, 8},
	{"???", 0x9B, AddrModeImm, 2, 2},
	{"???", 0xEB, AddrModeImm, 2, 2},
	{"???", 0x1A, AddrModeImp, 1, 2},
	{"???", 0x3A, AddrModeImp, 1, 2},
	{"???", 0x5A, AddrModeImp, 1, 2},
	{"???", 0x7A, AddrModeImp, 1, 2},
	{"???", 0xDA, AddrModeImp, 1, 2},
	{"???", 0xFA, AddrModeImp, 1, 2},
	{"???", 0x80, AddrModeImm, 2, 2},
	{"???", 0x82, AddrModeImm, 2, 2},
	{"???", 0x89, AddrModeImm, 2, 2},
	{"???", 0xC2, AddrModeImm, 2, 2},
	{"???", 0xE2, AddrModeImm, 2, 2},
	{"???", 0x04, AddrModeZp, 2, 3},
	{"???", 0x44, AddrModeZp, 2, 3},
	{"???", 0x64, AddrModeZp, 2, 3},
	{"???", 0x14, AddrModeZpX, 2, 4},
	{"???", 0x34, AddrModeZpX, 2, 4},
	{"???", 0x54, AddrModeZpX, 2, 4},
	{"???", 0x74, AddrModeZpX, 2, 4},
	{"???", 0xD4, AddrModeZpX, 2, 4},
	{"???", 0xF4, AddrModeZpX, 2, 4},
	{"???", 0x0C, AddrModeAbs, 3, 4},
	{"???", 0x1C, AddrModeAbsX, 3, 4}, // +1 if page crossed
	{"???", 0x3C, AddrModeAbsX, 3, 4}, // +1 if page crossed
	{"???", 0x5C, AddrModeAbsX, 3, 4}, // +1 if page crossed
	{"???", 0x7C, AddrModeAbsX, 3, 4}, // +1 if page crossed
	{"???", 0xDC, AddrModeAbsX, 3, 4}, // +1 if page crossed
	{"???", 0xFC, AddrModeAbsX, 3, 4}, // +1 if page crossed
}
